 ...
 */
public class MaterialWatchFaceService extends CanvasWatchFaceService {
    ...
    private class WPEngine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mClient = new GoogleApiClient.Builder(MaterialWatchFaceService.this).addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                @Override
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(MaterialWatchFaceService.this)
            ...
            mBackgroundPaint.setARGB(255, 43, 41, 46);
            mHourPaint.setARGB(255, 236, 240, 241);
            mMinutePaint.setARGB(255, 236, 240, 241);
            mCenterPaint.setARGB(255, 236, 240, 241);
            mTextPaint.setARGB(255, 189, 195, 199);
            mIconPaint.setColorFilter(new PorterDuffColorFilter(getResources().getColor(R.color.icon_tint), PorterDuff.Mode.MULTIPLY));
            mBatteryBackgroundPaint.setARGB(70, 255, 255, 255);

            mDateTextPath = new Path();

            Resources resources = MaterialWatchFaceService.this.getResources();
        ...
        private void registerTimeZoneReceiver() {
            ...
            MaterialWatchFaceService.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterTimeZoneReceiver() {
            ...
            MaterialWatchFaceService.this.unregisterReceiver(mTimeZoneReceiver);
        }
